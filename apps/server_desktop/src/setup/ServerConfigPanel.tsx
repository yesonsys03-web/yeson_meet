...
const styles: Record<string, React.CSSProperties> = {
  panel: { padding: "16px 20px", borderBottom: "1px solid #1d2733", background: "#0e141b", color: "#d4dde6" },
  heading: { fontSize: 14, margin: "0 0 4px", fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.5 },
  sub: { margin: "0 0 12px", fontSize: 12, color: "#7f8c9b" },
  ...
  fieldLabel: { fontSize: 11, textTransform: "uppercase", letterSpacing: 0.5, color: "#6b7c8d" },
  input: {
    padding: "6px 8px",
    background: "#0b1117",
  ...
  primary: { background: "#15803d", borderColor: "#15803d", color: "#fff", fontWeight: 600 },
  error: { margin: "12px 0 0", color: "#ff6b6b", fontSize: 13 },
  notice: { margin: "12px 0 0", color: "#4ade80", fontSize: 13 },
};
