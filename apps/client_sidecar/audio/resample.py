...
# === ANCHOR: RESAMPLE_RESAMPLER_START ===
class Resampler:
    """Convert mono float32 from src_rate to TARGET_SAMPLE_RATE."""

    # === ANCHOR: RESAMPLE___INIT___START ===
    ...
    # === ANCHOR: RESAMPLE___INIT___END ===

    # === ANCHOR: RESAMPLE_PROCESS_START ===
    def process(self, buf_float32_mono: np.ndarray) -> np.ndarray:
        if self.src_rate == self.dst_rate:
# === ANCHOR: RESAMPLE_RESAMPLER_END ===
